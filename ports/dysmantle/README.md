# dysmantle — NextOS Android port

Port gerado por `nextos_ports_android`. `.so`: `libNativeGame.so`.

## Game files (BYO — você fornece, do seu APK legítimo)
- `libNativeGame.so` (de lib/arm64-v8a/)
- assets / OBB conforme o jogo

## Estado
- [ ] Resolver UNKNOWN em src/imports.gen.c (158 símbolos)
